...
> “Como a perícia cibernética está intimamente relacionada à resposta a incidentes, alguns elementos dos programas de resposta podem contribuir para a complexidade da aplicação de atividades forenses tradicionais no domínio de sistemas de controle. Um exemplo simples é a coleta de artefatos e dados. Uma perícia cibernética eficaz exige que uma equipe de resposta realize a coleta de dados de forma que envolva a identificação, o registro ou a cópia e a identificação adequada dos materiais provenientes de diversas fontes de dados ao longo da arquitetura de informação. A equipe de resposta também deve realizar essa coleta de maneira oportuna.
>
> Na maioria dos ambientes modernos de sistemas de controle, existem tecnologias capazes de fornecer alguns desses requisitos mínimos. Entretanto, algumas das principais tecnologias de suporte e controle do sistema (aquelas que poderiam ser alvos de um invasor) simplesmente não permitem e não foram projetadas para possibilitar uma coleta de dados eficaz por um analista de perícia cibernética. Outros métodos de coleta, como aqueles associados à detecção e ao registro baseados em rede e em hosts, podem introduzir custos que podem ser elevados, dependendo da natureza, do tamanho e da criticidade da rede de sistemas de controle." FABRO, Mark; CORNELIUS, Eric. Recommended Practice: Creating Cyber Forensics Plans for Control Systems. DHS National Cyber Security Division – Control Systems Security Program, August 2008. Seção: 1. Traditional Forensics and Challenges to Control Systems. Subseção: 1.1 Challenges with Collection p. 8.
